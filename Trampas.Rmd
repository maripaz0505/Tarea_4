...
Voy a eliminar la codificación de zonas latitudinalespara no hacer tanto spam.
...
Voy a hacer un modelo de regresión lineal que incluya las poblaciones como unidades de muestreo:

```{r}
lm(D ~ L + H1 + H2 + H3 + H4 + H5 + (1|P), data = Datos_tarea4)
